...
const NeonButton = (props) => {
  ...
  const finalSettings = {
    color: props.settings.color || `hsl(317 100% 54%)`,
    colorBg: props.settings.colorBg || `hsl(323 21% 16%)`,
    fontSize: props.settings.fontSize || `1.5rem`,
    transitionSpeed: props.settings.transitionSpeed || '100',
